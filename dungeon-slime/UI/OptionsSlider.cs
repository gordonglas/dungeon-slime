...
public class OptionsSlider : Slider
{
    ...
    public OptionsSlider(TextureAtlas atlas)
    {
        ...
        // Note that the above code specifies the entire panel-background
        // texture size, including it's borders, so how does the NineSliceRuntime
        // know not to repeat the borders in that texture when it's stretched?
        // Because the default behavior is to divide the texture into thirds.
        // When NineSliceRuntime.CustomFrameTextureCoordinateWidth is not set (like above),
        // it defaults to:
        // * 1/3 of the texture width for the left/right borders.
        // * 1/3 of the texture height for the top/bottom borders.
        // * The remaining center 1/3 stretches to fill the scaled size.
        // Since the panel-background texture is 15x15 pixels, this means:
        // * Left and right borders: ~5 pixels each
        // * Top and bottom borders: ~5 pixels each
        // * Center stretchable region: ~5x5 pixels
